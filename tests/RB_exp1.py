...
file keywords_rule_based_classifier_V1.py
"""
import os
...
from src.models.Rule_Based.keywords_rule_based_classifier_V1 import classify_utterances, custom_keywords, stops
...
output_file_path = os.path.join(project_root, 'tests', 'classified_utterances.csv')
